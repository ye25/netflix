...
d) Why are some movies missing? What kind of bias might be caused by omitting incomplete data? Create a subset of your data by omitting all the NA observations (call this dataset “rockyDB_noNA”). Report the bias in the mean ratings from this subsetted data. Hint: Look at the na.omit function (5 marks).
```{r}
```
