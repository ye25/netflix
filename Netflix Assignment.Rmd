...
+e) Some missing data analysis instead build a statistical model based on the complete observations to ‘fill in’ the missing values. Why might the data still be biased after this
...
rockyDB_noNA5$rocky1[is.na(rockyDB_noNA5$rocky1)] <- "isMissing1"
rockyDB_noNA5$rocky2[is.na(rockyDB_noNA5$rocky2)] <- "isMissing2"
rockyDB_noNA5$rocky3[is.na(rockyDB_noNA5$rocky3)] <- "isMissing3"
rockyDB_noNA5$rocky4[is.na(rockyDB_noNA5$rocky4)] <- "isMissing4"

missing5v1 <- rockyDB_noNA5[which(rockyDB_noNA5$rocky1=="isMissing1"),]
missing5v2 <- rockyDB_noNA5[which(rockyDB_noNA5$rocky2=="isMissing2"),]
missing5v3 <- rockyDB_noNA5[which(rockyDB_noNA5$rocky3=="isMissing3"),]
missing5v4 <- rockyDB_noNA5[which(rockyDB_noNA5$rocky4=="isMissing4"),]
